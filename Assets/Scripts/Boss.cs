...
public class Boss : MonoBehaviour {
	...
	public float timeBetweenDropStore;
	...
	void Update () {
		...
		if (bossActive) {
			...
			if (dropCount > 0) {
				...
				dropSawSpawnPoint.position = new Vector3 (Random.Range (leftPoint.position.x, rightPoint.position.x), dropSaw.transform.position.y, dropSaw.transform.position.z);
